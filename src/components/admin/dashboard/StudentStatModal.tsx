...
const StudentStatModal: React.FunctionComponent<IStudentStatModalProps> = ({
  studentDataCollect,
  toggleStudentModal,
  studentId,
}) => {
  ...
  //   USE EFFECT
  React.useEffect(() => {
    const findStudent = studentDataCollect.find(
      (items) => items.id === studentId
    );
  ...
  return (
    <div
      className={
        "fixed z-[90] w-[80%] top-0 left-0 h-screen bg-dark bg-opacity-50 flex items-center justify-center"
      }
    >
...
export default StudentStatModal;
