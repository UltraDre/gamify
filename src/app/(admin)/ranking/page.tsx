...
const Ranking: React.FunctionComponent<IRankingProps> = (props) => {
  ...
  return (
    <div className="bg-light min-h-screen flex items-center justify-center">
      <div className="w-[60%] rounded-lg bg-white px-10 py-14 h-[900px]">
        ...
        <div className="flex gap-x-10 mt-10 px-20 justify-between">
          <div className="relative mt-10 cursor-pointer" onClick={() => handleViewProfile(topDog[1].id)}>
          ...
          <div className="relative cursor-pointer" onClick={() => handleViewProfile(topDog[0].id)}>
          ...
          <div className="relative mt-12 cursor-pointer" onClick={() => handleViewProfile(topDog[2].id)}>
